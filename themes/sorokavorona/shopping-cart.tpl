	...
	<section>
		<div class="container-fluid">
			<div class="row">
				...
				<div id="order-detail-content" class="col-md-12 table_block table-responsive">
					<table  style="width: 100%;" id="cart_summary" class="table table-bordered {if $PS_STOCK_MANAGEMENT}stock-management-on{else}stock-management-off{/if}">
						<div class="cart-head">
							<div class="row">
								<div class="col-md-6">
									<div class="row">
						...
						<tr class="cart_total_price">
                            ...
                            {if $use_taxes}
								<td  class="price" id="total_price_container">
									<h4 class="cart_total_price text-left">
