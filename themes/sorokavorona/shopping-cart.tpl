					...
					<div class="cart-list">
						<div class="cart-head">
							<div class="row">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-4 cart_product first_item">
											<h6>{l s='Картинка'}</h6>
										</div>
										<div class="col-md-8 cart_description item">
											<h6>{l s='название / артикул'}</h6>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-3 cart_quantity item">
											<h6>{l s='количество'}</h6>
										</div>
										<div class="col-md-3 cart_unit item">
											<h6>{l s='цена за шт.'}</h6>
										</div>
										<div class="col-md-3 cart_total">
											<h6>{l s='цена за все'}</h6>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cart-item">
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="row">
										<div class="col-md-4"><img src="{$link->getImageLink($lastProductAdded.link_rewrite, $lastProductAdded.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="{$lastProductAdded.name|escape:'html':'UTF-8'}" alt=""></div>
										<div class="col-md-8">
											<h2>{$lastProductAdded.name|escape:'html':'UTF-8'}</h2>
											<p>Артикул: <span>{$lastProductAdded.reference|escape:'html':'UTF-8'}</span></p>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-6">
									<div class="row">
										<div class="col-md-3">
											<div class="product-how-quantity"><span class="quantity-minus">-</span>
												<input type="number" value="1" class="quantity-amount"><span class="quantity-plus">+</span>
											</div>
										</div>
