...
class VideoProductsControllerCore extends FrontController
{
    public $php_self = 'video-products';
    ...
    public function initContent()
    {
        ...
        $nb_products = (int)Product::getProductsWithVideo(
        ...
        $products = Product::getProductsWithVideo($this->context->language->id,
            (int)$this->p - 1,
            (int)$this->n,
            $this->orderBy,
            $this->orderWay);
        ...
        $this->setTemplate(_PS_THEME_DIR_.'video-products.tpl');
    }
}
